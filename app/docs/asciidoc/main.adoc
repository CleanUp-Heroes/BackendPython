...
==== Diagramme de Classe  : choisir l'un des deux
image::images/api1diagobjet1.png[Diagramme de classe, pdfwidth=75%] 
image::images/api1diagobjet2.png[Diagramme de classe, pdfwidth=75%] 
...
image::images/wire8.png[wire8, width=500, align=center]
