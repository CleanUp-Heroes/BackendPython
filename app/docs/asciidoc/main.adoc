...
=== FEATURE 3 : Création et Participation à des Événements de Nettoyage (Grande fonctionnalité)
...
image::images/livraisonObjet.png[Diagramme de Classe, width=500, align=center]
...
image::images/5.png[wire5, width=500, align=center]

=== Feature 3

image::images/6.png[wire6, width=500, align=center]
