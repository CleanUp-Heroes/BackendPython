...
=== Feature 8 : Vérification automatique des participations via photo

.**Objectif** :
Renforcer la fiabilité des participations aux défis en analysant automatiquement les preuves visuelles à l’aide d’une API de reconnaissance d’objets (Google Vision API). L’objectif est de s’assurer que la quantité déclarée correspond réellement au contenu visible sur la photo.

.**Fonctionnement** :

* Lorsqu’un utilisateur soumet une participation à un défi :

  * Il renseigne la **quantité réalisée**.
  * Il ajoute une **photo** comme preuve.
* La photo est envoyée au backend, qui utilise une **API de reconnaissance d’objets**.
* Le backend compare :

  * Le **nombre et type d’objets détectés** sur la photo.
  * La **quantité indiquée** dans le formulaire et le **type d'objets attendu**.
* Deux cas sont possibles :

  * **Correspondance** : La participation est **validée automatiquement**.
  * **Écart détecté** : La participation est **refusée**.

.**Nouvelle interface utilisateur : liste des participations**

* Une nouvelle page liste les **participations passées** à un défi.
  Pour chaque participation :
  * le nom du défi.
  * La **date de la participation**.
  * La **quantité** déclarée.
  * Statut affiché (Validée, Refusée).
  S’il s’agit d’une participation **refusée**, un formulaire intégré est affiché directement dans l’encadré :

    * Un champ quantité modifiable.
    * Un champ pour joindre une nouvelle image.
    * Un bouton de resoumission.

À la validation de ce formulaire, une nouvelle vérification est lancée via l’API, et la participation est à nouveau traitée.

.**But principal** :
Renforcer la **vérifiabilité**, **limiter les abus**, et **fiabiliser les statistiques** tout en offrant à l’utilisateur une **nouvelle chance** en cas d’erreur.

==== Diagramme de Séquence


image::images/imgclaire1Api.png[Diagramme de l'API , width=500]  

image::images/imgclaire2Api.png[Diagramme de séquence, pdfwidth=75%]  

==== Diagramme de Classe 
image::images/api1diagobjet3.png[Diagramme de classe, pdfwidth=75%] 

=== Feature 9 : Suivi de l’impact environnemental

.**Objectif** :  
Donner à l’utilisateur une mesure claire et motivante de l’impact positif de ses actions, exprimé en kilogrammes de CO₂ évités.  

.**Fonctionnement** :

* À chaque participation **validée** :
  * Le système évalue la quantité totale de déchets traités.
  * Une **API d’empreinte carbone** calcule l’équivalent CO₂ évité.
  * Cette valeur est ajoutée au cumul personnel de l’utilisateur.
* L’ensemble de ces valeurs est agrégé pour produire :
  * Un **total** actualisé en temps réel.
  * Une **courbe d’évolution** qui montre la progression jour après jour.

.**Nouvelle interface utilisateur : page “Mon Impact”**

* Accessible depuis le menu principal.
* Affiche :
  * Un **compteur** indiquant le total de CO₂ évités.
  * Un **graphique interactif**..

.**But principal** :  
Rendre tangible l’effet écologique de chaque geste, renforcer la motivation et encourager la poursuite des défis grâce à une visualisation valorisante et cumulative.

==== Diagramme de Séquence

image::images/f9_diagSeq.png[Diagramme de séquence, pdfwidth=75%]

==== Diagramme de Classe

image::images/f9_diagClass.png[Diagramme de classe, pdfwidth=75%]
...
image::images/wire8.png[wire8, width=1000, align=center]

=== Feature 9 : 

image::images/image.png[wire9.1, width=1000, align=center]

image::images/image(1).png[wire9.2, width=1000, align=center]

image::images/image(2).png[wire9.3, width=1000, align=center]

image::images/image(4).png[wire9.4, width=1000, align=center]
